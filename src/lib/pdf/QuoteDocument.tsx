    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <Text style={styles.footer}>
          Generated by Roofactor — Roof area measurements are estimates based on
          satellite imagery and building footprint data. Actual measurements may
          vary. This quote is valid for 30 days from the date above.
        </Text>
      </Page>
    </Document>
  );
